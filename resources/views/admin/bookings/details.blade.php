                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="d-none d-xl-flex me-3">
                        <div class="d-flex flex-column pe-3 border-end border-primary">
                            ...
                            <a href="tel:+4733378901"><span class="text-primary">Free: +201288751504</span></a>
                        </div>
                    </div>
                ...
                <div class="row g-5">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-item">
                            ...
                            <p class="mb-4">These tickets are Reserved by {{DB::table('users')->where('id',DB::table('bookings')->where('ref_no',request()->ref_no)->value('user_id'))->value('name')}}.
                            </p>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <p  class="h4 d-inline-block mb-3">No. of Ticket</p>
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <p  class="h4 d-inline-block mb-3">Status</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <p href="#" class="h4 d-inline-block mb-3">Booked At</p>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <p  class="h4 d-inline-block mb-3">Ticket Cost</p>
                                                @if($bookings[0]->level==1)
                                                <h2 class="mb-0">{{count($bookings)*50}}EGP</h2>
                                                @else
                                                <h2 class="mb-0">{{count($bookings)*100}}EGP</h2>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <p href="#" class="h4 d-inline-block mb-3">Paid At</p>
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                        <div class="about-item">
                            ...
                            <h1 class="display-3 mb-3">Payemnt Methods</h1>
                            <p class="mb-4">You can Pay through Instapay App or Vodafone Cash
                                Your Tickets are not Activated till you pay and Call Us <strong>+201288751504</strong> with your Reference number <strong>{{$bookings[0]->ref_no}}</strong>
                            </p>
                            <div class="bg-light rounded p-4 mb-4">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <h3 class="h4 d-inline-block mb-3">Instapay</h3>
                                                <p class="mb-0">+201288751504</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                <h3 class="h4 d-inline-block mb-3">Vodafone Cash</h3>

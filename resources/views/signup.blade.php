										...
										<div class="main-signup-header">
											...
											<form action="#">
												<div class="form-group">
													<label>Firstname &amp; Lastname</label> <input class="form-control" placeholder="Enter your firstname and lastname" type="text" required>
												</div>
												<div class="form-group">
													<label>Mobile</label> <input class="form-control" placeholder="Enter your Mobile number" type="tel" required>
												</div>
												<div class="form-group">

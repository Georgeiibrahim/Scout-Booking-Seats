					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" @if (Auth::guard('admin')->user()->image==null)
								...
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" @if (Auth::guard('admin')->user()->image==null)
												src="{{URL::asset('assets/img/faces/user.png')}}"
												@else
												src="../../user_img/{{Auth::guard('admin')->user()->id}}/{{Auth::guard('admin')->user()->image}}"
												@endif class=""></div>
									...
									<form action="{{ route('admin_logout') }}" method="POST">
										...
										{{-- <a class="dropdown-item" href="{{ route('admin_logout') }}"><i class="bx bx-log-out"></i> Sign Out</a> --}}
									</form>
								</div>
							</div>

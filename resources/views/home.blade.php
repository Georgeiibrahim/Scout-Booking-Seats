                ...
                <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="{{URL::asset('img/img1.jpg')}}" class="img-fluid w-100" alt="Image">
                            <div class="carousel-caption-1">
                                <div class="carousel-caption-1-content" style="max-width: 900px;">
                                    ...
                                    <div class="carousel-caption-1-content-btn fadeInLeft animated" data-animation="fadeInLeft" data-delay="1.7s" style="animation-delay: 1.7s;">
                                        <a class="btn btn-primary rounded-pill flex-shrink-0 py-3 px-5 me-2" href="{{route('book')}}">Book Now</a>
                                        <a class="btn btn-secondary rounded-pill flex-shrink-0 py-3 px-5 ms-2" href="{{route('contact')}}">Contact Us</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="{{URL::asset('img/img2.jpg')}}" class="img-fluid w-100" alt="Image">
                ...
                <div class="row g-4">
                    <div class=" col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item p-4">
                            <div class="feature-icon mb-3"><i class="fas fa-church text-white fa-3x"></i></div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex">
                                        ...
                                        <div class="ps-4">
                                            <div class="service-btn"><i class="fas fa-church text-white fa-2x"></i></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
